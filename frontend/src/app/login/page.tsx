  ...
  return (
    <div className="min-h-screen bg-light-bg flex flex-col items-center justify-center px-4 py-8">
      <div className="mb-6 w-full max-w-md">
        ...
        <Link href="/" className="flex items-center gap-2 text-amber-accent text-[13px] hover:underline mb-6">
          ← Volver al inicio
        </Link>
      </div>
      ...
      <Card className="w-full max-w-md">
        ...
        <div className="space-y-3 mb-6">
          ...
          <div className="relative">
            ...
            <Eye size={16} className="absolute right-3 top-9.5 text-text-secondary-light cursor-pointer" />
          </div>
        </div>
      ...
      <div className="mt-8 text-center max-w-md">
        <p className="text-[13px] text-text-secondary-light mb-4">Vista previa - Paso 2: Perfil profesional</p>
        <div className="space-y-2 opacity-40">
          <div className="h-10 bg-white border border-black/10 rounded-lg"></div>
          <div className="h-10 bg-white border border-black/10 rounded-lg"></div>
          <div className="flex gap-2">
            <div className="h-10 flex-1 bg-white border border-black/10 rounded-full"></div>
            <div className="h-10 flex-1 bg-white border border-black/10 rounded-full"></div>
          </div>
        </div>
      </div>
