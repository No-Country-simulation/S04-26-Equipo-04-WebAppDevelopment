export function Logo({ size = 'default', variant = 'light' }: { size?: 'default' | 'small'; variant?: 'light' | 'dark' }) {
  ...
  return (
    <div className="flex items-center gap-2">
      <div className={`${iconSize} rounded-lg bg-amber-accent flex items-center justify-center`}>
        <span className="text-dark-base text-[12px]" style={{ fontWeight: 500 }}>TR</span>
      </div>
      <div className={`${textSize}`} style={{ fontWeight: 500 }}>
