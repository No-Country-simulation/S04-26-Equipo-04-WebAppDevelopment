...
export default function HeroSection() {
  return (
    <section className="relative min-h-217.5 flex items-center overflow-hidden px-8 bg-surface">
        ...
        <div className="relative">
          ...
          <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl transform rotate-2">
            <Image
              ...
              src="/mujer.png"
            />
            <div className="absolute bottom-6 left-6 bg-white/70 glass-card p-6 rounded-xl shadow-lg border-l-4 border-secondary max-w-xs">
              <p className="font-heading text-primary mb-1">Valued Authority</p>
